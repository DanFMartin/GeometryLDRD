  ...
  if (!isEmpty())
    {
      ...
      // read data
      // (DFM - 9/15/25) set redefineData = false to avoid stripping
      // off ghost cells if checkpoint doesn't have them. This also
      // means we need to provide the component interval
      bool redefineData = false;
